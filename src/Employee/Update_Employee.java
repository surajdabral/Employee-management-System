...
public class Update_Employee extends Add_Employee implements ActionListener {
    ...
    Update_Employee(String idaa){
        super(0);
        f=new JFrame("Update Employee Deatils");
        f.setVisible(true);
        f.setSize(900,500);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b && i==1){
            try{ 
                conn con= new conn(); 
                String str;
                str="update employee set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+ "',education='"+t6.getText()+"',post='"+t7.getText()+"',aadhar='"+t8.getText()+"',emp_id='"+t9.getText()+"'where emp_id='"+id_emp+"'";
